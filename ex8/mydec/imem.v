...
module imem(input [`PCS:0] pc, output logic [`CMDS:0] o);
	always_comb
		...
		5'h00: o = 16'b100_0_00_01_0000_0011; //16 r0 = 3
		5'h01: o = 16'b010_0_10_00_0000_0000; //12 [0x00] = r0(b)
		5'h02: o = 16'b100_0_01_01_0000_0000; //16 r1 = 0
		5'h03: o = 16'b010_0_10_01_0000_0001; //12 [0x01] = r1(b)
		5'h04: o = 16'b100_0_10_01_0000_0010; //16 r2 = 2
		5'h05: o = 16'b010_0_10_10_0000_0010; //12 [0x02] = r2(b)
		5'h06: o = 16'b100_0_00_01_0000_0011; //16 r0 = 0x03
		5'h07: o = 16'b101_0_01_00_1111_1101; //20 r1 = [r0(a) + (-0x03)] ループの開始
		5'h08: o = 16'b101_0_10_00_1111_1110; //20 r2 = [r0(a) + (-0x02)]
		5'h09: o = 16'b000_0_10_11_0_000_01_10; //4 r3 = r1 + r2
		5'h0a: o = 16'b000_1_10_0_00_011_00_11; //8 [r0(a)] = r3
		5'h0b: o = 16'b001_0_00_00_0000_0001; //10 r0 = r0(a) + 0x01
		5'h0c: o = 16'b100_0_01_01_0001_0000; //16 r1 = 0x10
		5'h0d: o = 16'b000_0_11_000_001_00_01; //5 EVA r0(a) - r1(b) 条件チェック
		5'h0e: o = 16'b010_1_11_01_1111_1001; //13 (ze==0) JP pca + (-5'h07) ループ継続or終了処理
		// 5'h0f: o = 16'b000_1_00_01_1_000_00_00; //6 (ze==1) JP next (do nothing) ループ終了
		5'h0f: o = 16'b100_0_10_01_0000_0000; //16 r2 = 0
		5'h10: o = 16'b100_0_11_01_0000_0000; //16 r3 = 0x00
		5'h11: o = 16'b001_1_00_00_0000_0001; //10 r0 = r0(a) - 0x01 ループの開始
		5'h12: o = 16'b000_1_11_01_0_010_00_00; //9 r1 = [r0(b)]
		5'h13: o = 16'b000_0_10_10_0_000_10_01; //4 r2 = r2 + r1
		5'h14: o = 16'b000_0_11_000_001_00_11; //5 EVA r0(a) - r3(b)	条件チェック
		5'h15: o = 16'b010_1_11_01_1111_1100; //13 (ze==0) JP pca + (-5'h04) ループ継続or終了処理
		// 5'h17: o = 16'b000_1_00_01_1_000_00_00; //6 (ze==1) JP next (do nothing) ループ終了
		5'h16: o = 16'b010_0_10_10_0001_0000; //12 [0x10] = r2(b)
		5'h17: o = 16'b000_0_00_00_0000_0001; //2 halt
